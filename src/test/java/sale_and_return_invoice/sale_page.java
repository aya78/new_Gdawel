...
public class sale_page {
    ...
    public static WebElement select_payment_with_giftCard(WebDriver driver) {
        element = driver.findElement(By.xpath("//*[@id=\"bs-select-8-1\"]"));
        return element;
    }
    public static WebElement click_dropdown_of_gift_card(WebDriver driver) {
        element = driver.findElement(By.xpath("//*[@id=\"add-payment\"]/div/div/div[2]/form/div[2]/div/button"));
        return element;
    }
    // //*[@id="bs-select-9-0"]
