...
/* ---------------------------------------------------------Invalid data in Step3 -------------------------------------------------- */
public class Invalid_register_test2 {
    String Tax= RandomStringUtils.random(5, false, true);
    String Traditional = RandomStringUtils.random(12    , false, true);
...
//        Thread.sleep(2000);
    ...
    public void Register_Step3() throws InterruptedException {
        ...
        register_Page.enter_first_address(driver).sendKeys(" ");
