...
public class register_test2 {
    ...
    public void Register_Step1() throws InterruptedException {
        ...
        // Step 1
        register_Page.click_country2(driver).click();
        register_Page.click_plan2(driver).click();
        register_Page.click_company_account(driver).click();
