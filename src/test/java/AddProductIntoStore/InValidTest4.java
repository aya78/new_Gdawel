...
/** هذا المنتج له دفعه و تاريخ انتهاء صلاحيه**/
    ...
    /**  طريقه الضرايب ضريبه شامله و الضريبه صفريه* */
        ...
        public void add_product_page() throws InterruptedException {
            /**  ------------------------enter digits in product_name----------------------------**/
            /**  ------------------------enter string in product_cost & Product_selling_price----------------------------**/
            ...
            Thread.sleep(2000);
            product_page.enterProductName(driver).sendKeys("5654555");
...
//        product_page.click_quantity(driver).sendKeys("10");
            ...
            product_page.click_product_cost(driver).sendKeys("" + random_string);
            product_page.click_Product_selling_price(driver).sendKeys("" + random_string);
