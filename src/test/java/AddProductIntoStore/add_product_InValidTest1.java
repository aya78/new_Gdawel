...
public class add_product_InValidTest1 {
    ...
    public void add_product_page() throws InterruptedException {
        ...
        product_page.click_barcode_generator(driver).sendKeys("03122598");
        Thread.sleep(2000);
        ...
        product_page.click_product_cost(driver).sendKeys("00"+random_number);
        product_page.click_Product_selling_price(driver).sendKeys("00"+random_number);
