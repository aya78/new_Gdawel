...
//    }
    ...
    public static WebElement clickAddService(WebDriver driver){
        element = driver.findElement(By.xpath("//*[@id=\"first\"]/div/div/div[2]/div"));
        return element;
    }
    ...
    public static WebElement select_brand(WebDriver driver){
        element = driver.findElement(By.cssSelector("#bs-select-13-0"));
        return element;
    }
    // (//div[@class='mb-3']//input)[2]
    // click_product_cost
    public static WebElement click_product_cost(WebDriver driver){
        element = driver.findElement(By.xpath("(//div[@class='mb-3']//input)[2]"));
        return element;
    }
