...
//    }
    ...
    public static WebElement select_store(WebDriver driver) throws InterruptedException {
        ...
        Select skills = new Select(element);
        int dropdown_value= driver.findElements(By.cssSelector("#purchase-form > div.card > div > div > div:nth-child(3) > div > div.dropdown.bootstrap-select.form-control.dropup > select > option")).size();
        System.out.println(dropdown_value);
